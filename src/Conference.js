    ...
    <section className="max-w-5xl mx-auto px-6 py-20 text-gray-800 bg-white">
      ...
      <ul className="pl-4 space-y-6 text-gray-800 leading-relaxed">
        ...
        <li className="flex items-start gap-2">
          <span className="w-1 h-1 mt-2 rounded-full bg-black"></span>
          <p className="text-sm whitespace-pre-line">
            <strong>June 2019:</strong> The Fourth International Workshop on Boolean Functions and Their Applications (BFA), Florence, Italy (attendee)
          </p>
        </li>
        <li className="flex items-start gap-2">
          <span className="w-1 h-1 mt-2 rounded-full bg-black"></span>
          <p className="text-sm whitespace-pre-line">
            <strong>May 2019:</strong> Workshop on Polynomials and Curves over Finite Fields, İstanbul, Turkey (attendee)
          </p>
        </li>
        <li className="flex items-start gap-2">
          <span className="w-1 h-1 mt-2 rounded-full bg-black"></span>
          <p className="text-sm whitespace-pre-line">
            <strong>May 2019:</strong> XXI. Antalya Algebra Days, İzmir, Turkey (attendee)
          </p>
        </li>
        <li className="flex items-start gap-2">
          <span className="w-1 h-1 mt-2 rounded-full bg-black"></span>
        ...
        <li className="flex items-start gap-2">
          <span className="w-1 h-1 mt-2 rounded-full bg-black"></span>
          <p className="text-sm whitespace-pre-line">
            <strong>April 2018:</strong> Workshop on Finite Fields, Function Fields and Their Applications, İstanbul, Turkey (attendee)
          </p>
        </li>
        <li className="flex items-start gap-2">
          <span className="w-1 h-1 mt-2 rounded-full bg-black"></span>
          <p className="text-sm whitespace-pre-line">
            <strong>May 2016:</strong> XVIII. Antalya Algebra Days, İzmir, Turkey (attendee)
          </p>
        </li>
        <li className="flex items-start gap-2">
          <span className="w-1 h-1 mt-2 rounded-full bg-black"></span>
          <p className="text-sm whitespace-pre-line">
            <strong>September 2015:</strong> 28. National Mathematics Symposium, Antalya, Turkey (attendee)
          </p>
        </li>
        <li className="flex items-start gap-2">
          <span className="w-1 h-1 mt-2 rounded-full bg-black"></span>
          <p className="text-sm whitespace-pre-line">
            <strong>June 2014:</strong> The 3rd Workshop on Rings, Modules and Algebras, İzmir, Turkey (attendee)
          </p>
        </li>
        <li className="flex items-start gap-2">
          <span className="w-1 h-1 mt-2 rounded-full bg-black"></span>
          <p className="text-sm whitespace-pre-line">
            <strong>August 2013:</strong> The International Conference on Algebra in Honour of Patrick Smith and John Clark’s 70th Birthdays, Balıkesir, Turkey (attendee)
          </p>
        </li>
      </ul>
    </section>
