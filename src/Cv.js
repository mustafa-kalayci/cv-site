...
Research Assistant, İzmir Institute of Technology, İzmir, Turkey
        ...
        <section>
          <h2 className="text-2xl font-boldtext-[#744f9c] mb-2">Teaching</h2>
          <p className="leading-relaxed whitespace-pre-line">
...
Math 361: Abstract Algebra (Teaching assistant)
        ...
        <section>
          <h2 className="text-2xl font-bold text-[#744f9c] mb-2">Supervision</h2>
          <p className="leading-relaxed whitespace-pre-line">
...
(with <strong>Dr. Nurdagül Anbar</strong>)
        ...
        <section>
          <h2 className="text-2xl font-bold text-[#744f9c] mb-2 ">Honors and Awards</h2>
          <p className="leading-relaxed whitespace-pre-line">
...
<span >IEEE Transactions on Information Theory</span><br />
<span >Designs, Codes and Cryptography</span><br />
<span >Finite Fields and Their Applications</span><br />
<span >Advances in Mathematics of Communication</span><br />
<span >Applicable Algebra in Engineering, Communication and Computing</span><br />
<span >Computational and Applied Mathematics</span>
<br></br>
<strong>Reviewer:</strong><br />
 <span >The Mathematical Reviews</span><br />
<span >zbMATH Open</span>
          </p>
        </section>

        <section>
          <h2 className="text-2xl font-bold text-[#744f9c] mb-2">Additional</h2>
          <p className="leading-relaxed whitespace-pre-line">
<strong>Language skills:</strong> Turkish (Mother's tongue), English (Advanced), German (Basic)<br />
<strong>IT Experience:</strong> Microsoft Office Applications (Word, Excel, PowerPoint), Latex, C Programming Language and Magma
          </p>
        </section>
      </div>
    </section>
